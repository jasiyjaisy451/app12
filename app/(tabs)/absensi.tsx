...
import { Calendar, CircleCheck as CheckCircle, Circle as XCircle, Clock, Users, User, ChartBar as BarChart3, MapPin, Download, ListFilter as Filter, X, FileText, Search, RefreshCw, Eye, ChevronRight } from 'lucide-react-native';
        ...
        <Animated.View entering={FadeInUp.delay(200)} style={styles.searchFilterContainer}>
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.filterScroll}>
            {[
              ...
              { key: 'tidak_hadir', label: 'Alpha', icon: XCircle },
            ].map((filter) => {
